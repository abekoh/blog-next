...
import { Methods as Methods3 } from './v1/posts'
import { Methods as Methods4 } from './v1/posts/_id@string'
import { Methods as Methods5 } from './v1/sitedata'
import { Methods as Methods6 } from './v1/tags'
import { Methods as Methods7 } from './v1/tags/_id@string'

const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  const prefix = (baseURL === undefined ? '' : baseURL).replace(/\/$/, '')
  const PATH0 = '/v1/about'
  const PATH1 = '/v1/categories'
  const PATH2 = '/v1/posts'
  const PATH3 = '/v1/sitedata'
  const PATH4 = '/v1/tags'
  const GET = 'GET'
        ...
        _id: (val2: string) => {
          ...
          return {
            get: (option?: { query?: Methods7['get']['query'], config?: T }) =>
              fetch<Methods7['get']['resBody']>(prefix, prefix2, GET, option).json(),
            $get: (option?: { query?: Methods7['get']['query'], config?: T }) =>
