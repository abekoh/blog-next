  ...
  return {
    v1: {
      ...
      categories: {
        _id: (val2: string) => {
          ...
          return {
            ...
            $get: (option?: { query?: Methods2['get']['query']; config?: T }) =>
              fetch<Methods2['get']['resBody']>(prefix, prefix2, GET, option)
                .json()
                .then((r) => r.body),
            $path: (option?: {
              method?: 'get';
      ...
      posts: {
        _id: (val2: string) => {
          ...
          return {
            ...
            $get: (option?: { query?: Methods5['get']['query']; config?: T }) =>
              fetch<Methods5['get']['resBody']>(prefix, prefix2, GET, option)
                .json()
                .then((r) => r.body),
            $path: (option?: {
              method?: 'get';
      ...
      sitedata: {
        ...
        $get: (option?: { query?: Methods6['get']['query']; config?: T }) =>
          fetch<Methods6['get']['resBody']>(prefix, PATH4, GET, option)
            .json()
            .then((r) => r.body),
      ...
      tags: {
        ...
        $get: (option?: { query?: Methods7['get']['query']; config?: T }) =>
          fetch<Methods7['get']['resBody']>(prefix, PATH5, GET, option)
            .json()
            .then((r) => r.body),
